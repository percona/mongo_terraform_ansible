...
1. Prepare an `inventory` file (or use one generated by Terraform / the Web UI)

2. Edit the [variable files](group_vars/all.yml) to choose the options, passwords, ports, etc.
